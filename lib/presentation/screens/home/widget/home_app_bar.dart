...
import 'package:cigar/utils/app_const/app_const.dart';
    ...
    return AppBar(
      ...
      title: Column(
        ...
        children: [
          ...
          Text("Hello ${controller.profile.value.data?.firstName??""} ${controller.profile.value.data?.lastName??""}  !".tr, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)):
          Shimmer.fromColors(
            baseColor: AppColors.whiteColor.withValues(alpha: 0.2),
            highlightColor: AppColors.whiteColor.withValues(alpha: 0.5),
            child: Column(
          ...
          Text("welcome_to_cigarslounges".tr, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w400))
        ],
      ),
