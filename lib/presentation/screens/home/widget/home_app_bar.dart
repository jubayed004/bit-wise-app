    ...
    return AppBar(
      ...
      title: Column(
        ...
        children: [
          ...
          Text("Hello Jane Copper ${controller.profile.value.data?.firstName??""} ${controller.profile.value.data?.lastName??""}", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)):
          Shimmer.fromColors(
            baseColor: AppColors.whiteColor.withValues(alpha: 0.2),
            highlightColor: AppColors.whiteColor.withValues(alpha: 0.5),
            child: Column(
