    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverAppBar(
            floating: false,   // 🔥 No floating behavior
            snap: false,       // 🔥 No snapping
            pinned: false,     // 🔥 AppBar will hide completely when scrolling up
            backgroundColor: Colors.white,
            elevation: 0,
             toolbarHeight: 90,
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Text("Featured Section", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),
          ),
